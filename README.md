...
2. Clone this repo
```
git clone https://github.com/toyman640/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/toyman640/hello-rails-back-end/issues)
